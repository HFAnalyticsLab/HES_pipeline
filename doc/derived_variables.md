...
**Description:** More complete version of the date the patient was discharged 
from hospital at the end of an inpatient spell.   
**Table:** APCS    
**Data type:** character (see adr/storing_dates_in_database.md)         
**Values:**     
**Missing values**:     
...
were unplanned and which were seen (SEEN, UNPLANNED, UNPLANNED_SEEN) and for 
spell creation??    
**References:**      
...
## EPIKEY_DIS    
**Label:**  Discharge episode identifier    
...
**Values:** TRUE/1 = yes, FALSE/0 = no         
**Missing values**: `NA`     
**Derivation function:** `set_new_spell()` and `set_not_new_spell()`    
...
across the columns listed below.    
**Dependencies:**    
...
and DUPLICATE = FALSE, else set to FALSE.   
...
**Values:**     
**Missing values**:     
**Derivation function:** `set_spell_id()`    
